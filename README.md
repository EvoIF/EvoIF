...
This codebase is based on PyTorch and [TorchDrug](https://github.com/DeepGraphLearning/torchdrug) ([TorchProtein](https://torchprotein.ai)). Code is archived on [Zenodo](https://doi.org/10.5281/zenodo.20139484).
